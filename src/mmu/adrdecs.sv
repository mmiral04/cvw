...
module adrdecs import cvw::*;  #(parameter cvw_t P) (
 ...
 // Determine which region of physical memory (if any) is being accessed
  ...
  adrdec #(P.PA_BITS) dispdec(PhysicalAddress, P.DISP_BASE[P.PA_BITS-1:0], P.DISP_RANGE[P.PA_BITS-1:0], P.DISP_SUPPORTED, AccessRW, Size, SUPPORTED_SIZE, SelRegions[12]);
