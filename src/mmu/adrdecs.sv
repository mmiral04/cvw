...
module adrdecs import cvw::*;  #(parameter cvw_t P) (
 ...
 // Determine which region of physical memory (if any) is being accessed
  ...
  adrdec #(P.PA_BITS) ethdec(PhysicalAddress, P.ETH_BASE[P.PA_BITS-1:0], P.ETH_RANGE[P.PA_BITS-1:0], P.ETH_SUPPORTED, AccessRWXCs, Size, SUPPORTED_SIZE, SelRegions[12]);
