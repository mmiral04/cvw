...
module adrdecs import cvw::*;  #(parameter cvw_t P) (
 ...
 // Determine which region of physical memory (if any) is being accessed
  ...
  adrdec #(P.PA_BITS) periphdec(PhysicalAddress, P.PERIPH_BASE[P.PA_BITS-1:0], P.PERIPH_RANGE[P.PA_BITS-1:0], P>PERIPH_SUPPORTED, AccessRW, Size, 4'b0111, SelRegions[12]);
